  ...
  temporal(
    ...
    }),
    {
      ...
      partialize: (state) => ({
        ...
        tileSizeUnit: state.tileSizeUnit,
        tileDpi: state.tileDpi,
        aspectLocked: state.aspectLocked,
        backgroundColor: state.backgroundColor,
        layers: state.layers,
        repeatMode: state.repeatMode,
        shiftPercent: state.shiftPercent,
        tileDirection: state.tileDirection,
        showGuides: state.showGuides,
        guideType: state.guideType,
        snapEnabled: state.snapEnabled,
        previewTilesX: state.previewTilesX,
        previewTilesY: state.previewTilesY,
      }),
    },
  ),
)
